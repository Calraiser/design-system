...
.PHONY: lint-prettier
lint-prettier:
	./node_modules/.bin/prettier -l .babelrc webpack.config.js 'source/assets/{javascripts,stylesheets}/**/*.{js,graphql,scss,css})'
...
format-prettier:
	./node_modules/.bin/prettier --write '.babelrc' 'webpack.config.js' 'source/assets/{javascripts,stylesheets}/**/*.{js,graphql,scss,css}'
