<header class="bx--header" role="banner" aria-label="IBM Platform Name" data-header>
  ...
  <button class="bx--header__menu-trigger bx--header__action" aria-label="Open menu" title="Open menu"
    ...
    data-navigation-menu-target="#navigation-menu-u6iun6kekmn">
    ...
    <svg focusable="false" preserveAspectRatio="xMidYMid meet" style="will-change: transform;" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" class="bx--navigation-menu-panel-expand-icon" width="20" height="20" viewBox="0 0 20 20"><path d="M2 15h16v1.2H2zm0-3.8h16v1.2H2zm0-3.7h16v1.2H2zm0-3.7h16V5H2z"></path></svg>
  </button>
  ...
  <div class="bx--header__global">
    <button class="bx--header__menu-trigger bx--header__action" aria-label="Action 1"
      ...
      data-navigation-menu-panel-label-collapse="Close menu" data-product-switcher-target="#switcher-zgdernbmioj">
...
<aside class="bx--side-nav bx--side-nav--fixed" data-side-nav>
  ...
  </aside><div class="bx--navigation" id="navigation-menu-u6iun6kekmn"
