<button class="bx--btn bx--btn--danger--primary" type="button" data-modal-target="#modal-jzkxgw0id8">Show
  modal</button>

<div data-modal id="modal-jzkxgw0id8" class="bx--modal bx--modal--danger" role="dialog"
  aria-modal="true" aria-labelledby="modal-jzkxgw0id8-label" aria-describedby="modal-jzkxgw0id8-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-jzkxgw0id8-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-jzkxgw0id8-heading">Modal heading</p>
