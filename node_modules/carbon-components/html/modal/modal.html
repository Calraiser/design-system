<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-a9r4zf4e5rc">Show
  modal</button>

<div data-modal id="modal-a9r4zf4e5rc" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-a9r4zf4e5rc-label" aria-describedby="modal-a9r4zf4e5rc-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-a9r4zf4e5rc-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-a9r4zf4e5rc-heading">Modal heading</p>
