    ...
    (l.prototype.generateFlow = function(E) {
      ...
      return function() {
        ...
        V.add(I.xAxis(I.axes.x, G)),
          ...
          V.add(l.transition(G).attr("transform", e)),
          ...
          .each(function(t, e) {
            ...
            i.classed(Y.line) ||
              ...
              (a && o
                ...
                : D(l) && l && s && r(!1, i.classed(Y.SELECTED, !1), t, e));
          });
    }),
            ...
            c.isLineType(t)
              ? d.data_regions[t.id]
                ...
                : (c.isStepType(t) && (i = c.convertValuesToStep(i)),
                  (e = l.curve(c.getInterpolate(t))(i)))
        ...
        g = _.axis_rotated
          ...
          r = f.isTimeSeries()
            ? function(t, e, i, n) {
                ...
                return w(
                  _.axis_rotated
                    ? [[d(l(i)), c(o)], [d(l(i + n)), c(s)]]
                    : [[c(o), d(l(i))], [c(s), d(l(i + n))]]
                );
              }
            : function(t, e, i, n) {
                return w(
                  _.axis_rotated
                    ? [[d(l(i), !0), c(a(i))], [d(l(i + n), !0), c(a(i + n))]]
                    : [[c(a(i), !0), d(l(i))], [c(a(i + n), !0), d(l(i + n))]]
                );
              },
          i = 0;
        i < t.length;
