...
!(function(e, t) {
  ...
  function f(e) {
    ...
    return (
      0 <= r.right - o &&
      0 <= r.bottom - a &&
      r.left + o <= window.innerWidth &&
      r.top + a <= window.innerHeight
    );
  }
  function l(e) {
    var a = e.target[o];
    a.ticking ||
      ...
      r(function() {
        var e,
          ...
          r = n.length;
        for (t = 0; t < r; ++t)
          f((e = n[t])) && (u(e), (e[i].appeared = !0), e.update());
        a.ticking = !1;
      }));
  }
  function s(e) {
  ...
  function u(n) {
    n[i].elements.forEach(function(e) {
      ...
      t.splice(t.indexOf(n), 1),
        t.length || (a.removeEvent(e, "scroll", l), delete e[o]);
    }),
      (n[i].elements = []);
  }
        ...
        (e[i] = {
          ...
          (function(e) {
            for (var t, n, r = e.chart.canvas.parentElement; r; )
              s(r) &&
                (0 ===
                  (n = (t = r[o] || (r[o] = {})).charts || (t.charts = []))
                    .length && a.addEvent(r, "scroll", l),
                n.push(e),
                e[i].elements.push(r)),
