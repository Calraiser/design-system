...
(function(t, n) {
    ...
    function u(t, n, e, o) {
      t !== n
        ? (t - n > 180 ? (n += 360) : n - t > 180 && (t += 360),
          o.push({ i: e.push(i(e) + "rotate(", null, r) - 2, x: _h(t, n) }))
        : n && e.push(i(e) + "rotate(" + n + r);
    }
    function a(t, n, e, o) {
      t !== n
        ? o.push({ i: e.push(i(e) + "skewX(", null, r) - 2, x: _h(t, n) })
  ...
  function vi() {
    ...
    return (
      ...
      t
        .extentMajor([[-180, -90 + m_], [180, 90 - m_]])
        .extentMinor([[-180, -80 - m_], [180, 80 + m_]])
    );
  }
  function _i() {
    return vi()();
  ...
  var mf = "http://www.w3.org/1999/xhtml",
    ...
    bf = function(t) {
      ...
      return (
        ...
        xf.hasOwnProperty(n) ? { space: xf[n], local: t } : t
      );
    },
    wf = function(t) {
      var n = bf(t);
  ...
  if (((t.event = null), "undefined" != typeof document)) {
    ...
    "onmouseenter" in Af ||
      (Ef = { mouseenter: "mouseover", mouseleave: "mouseout" });
  }
  ...
  var Cp = 3,
    ...
    ed = { time: null, delay: 0, duration: 250, ease: ae },
    rd = function(t) {
      var n, e;
      t instanceof Qn
        ? ((n = t._id), (t = t._name))
  ...
  Fe.prototype = Ie.prototype = {
    ...
    entries: function() {
      var t = [];
      for (var n in this)
        n[0] === Ud && t.push({ key: n.slice(1), value: this[n] });
      return t;
    },
    size: function() {
      var t = 0;
  ...
  var K_,
    ...
    wy = [null, null],
    My = { type: "LineString", coordinates: wy },
    Ty = function(t, n) {
